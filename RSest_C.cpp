...
// Rcpp::List EstepC(arma::mat U, arma::cube R, arma::vec nu, arma::mat Q, arma::vec init){
//   
//   int d=U.n_cols;
//   int r=Q.n_cols;
//   int n=U.n_rows;
...
// Rcpp::List MstepC(arma::mat U, arma::cube R, arma::vec nu, arma::mat Q, arma::vec init){
//   
//   int d=U.n_cols;
//   int r=Q.n_cols;
//   int n=U.n_rows;
...
//   arma::cube z(r,r,n-1);
//   
//   Rcpp::List wz=EstepC(U,R,nu,Q,init);
//   w=Rcpp::as<arma::mat>(wz["w"]);
//   z=Rcpp::as<arma::cube>(wz["z"]);
//   
